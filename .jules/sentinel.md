...
## 2026-06-19 - DOM-based XSS via escapeHTML
**Vulnerability:** DOM-based escapeHTML using div.textContent did not properly escape quotes, leading to XSS vulnerabilities when used in HTML attributes.
**Learning:** Relying on DOM methods for HTML escaping is insecure as it misses quote characters.
**Prevention:** Use a secure regex-based escape function that replaces all HTML special characters, including quotes, and enforce its use consistently across the codebase.
