...
## 2026-06-21 - Batched array unshift
**Learning:** Sequential unshift() inside a loop creates an O(N^2) memory reallocation bottleneck.
**Action:** Use a single batched O(N) operation using spread syntax: arr.unshift(...newItems.reverse())
