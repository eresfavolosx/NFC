...
export function renderAnalytics() {
    ...
    // ⚡ Bolt: Hoist Date.now() calculation outside the loop
    // Why: Evaluating Date.now() on every array element causes O(N) redundant overhead.
    // Impact: Converts an O(N) calculation to O(1), improving analytics calculation times for large arrays.
