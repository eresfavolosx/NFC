...
export function renderAnalytics() {
    ...
    // ⚡ Bolt: Hoist static Date.now() calculation out of the filter loop
    // Why: Repeated Date.now() evaluation inside O(N) loops causes unnecessary overhead for large datasets.
