...
export function renderAnalytics() {
    ...
    // ⚡ Bolt: Hoisted constant evaluation outside the loop to prevent O(N) repeated calculations of Date.now()
    const twentyFourHoursAgo = Date.now() - 86400000;
    const scansLast24h = analytics.filter(a => a.timestamp > twentyFourHoursAgo).length;
