        ...
        <div class="settings-form">
          ...
          <div class="form-group-row">
            <div class="form-info">
              ...
              <p class="form-desc" id="useBiometricsDesc">Use FaceID or TouchID to unlock administrative settings.</p>
            </div>
            <label class="switch">
              <input type="checkbox" id="useBiometrics" aria-describedby="useBiometricsDesc" ${settings.useBiometrics ? 'checked' : ''}>
