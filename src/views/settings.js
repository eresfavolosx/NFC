        ...
        <div class="settings-form">
          ...
          <div class="form-group-row">
            <div class="form-info">
              ...
              <p class="form-desc" id="biometric-desc">Use FaceID or TouchID to unlock administrative settings.</p>
            </div>
            <label class="switch">
              <input type="checkbox" id="useBiometrics" aria-describedby="biometric-desc" ${settings.useBiometrics ? 'checked' : ''}>
