...
function linkFormContent(link = null) {
    ...
    <div class="form-group">
      <label class="form-label" for="linkTitle">Title <span style="color: var(--color-error);" aria-hidden="true">*</span></label>
    ...
    <div class="form-group">
      <label class="form-label" for="linkUrl">URL <span style="color: var(--color-error);" aria-hidden="true">*</span></label>
