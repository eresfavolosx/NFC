            ...
            <div class="form-group-row" style="margin-top: var(--space-md)">
                <div class="form-info">
                    ...
                    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 0.5rem">
                        <label class="form-label" for="lock-tag-toggle" style="margin-bottom:0; cursor: pointer;">Lock Tag (Read-Only)</label>
                    ...
                    <p id="lock-tag-desc" class="text-sm text-muted" style="margin-top: 0.5rem">Permanent. Once locked, the tag cannot be erased or rewritten.</p>
                </div>
                </div>
            </div>
