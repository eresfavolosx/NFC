          ...
          <div class="writer-link-selector">
            ...
            <div class="form-group-row" style="margin-top: var(--space-md)">
                <div class="form-info">
                    ...
                    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 0.5rem">
                        <label class="form-label" style="margin-bottom:0" for="lock-tag-toggle">Lock Tag (Read-Only)</label>
                    ...
                    <label class="toggle-switch ${!store.isPremium() ? 'disabled' : ''}">
                        <input type="checkbox" id="lock-tag-toggle" aria-describedby="lock-tag-desc" ${!store.isPremium() ? 'disabled' : ''}>
                        <span class="toggle-slider"></span>
                    </label>
                    <p class="text-sm text-muted" id="lock-tag-desc" style="margin-top: 0.5rem">Permanent. Once locked, the tag cannot be erased or rewritten.</p>
                </div>
                </div>
            </div>
            ...
            <div class="writer-actions">
              ...
              <div class="form-group" style="margin-top: -var(--space-sm)">
                <label class="checkbox-container" style="display: flex; align-items: center; gap: var(--space-sm); font-size: var(--font-size-sm); cursor: pointer;" for="sequentialMode">
