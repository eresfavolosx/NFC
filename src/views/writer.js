          ...
          <div class="writer-link-selector">
            ...
            <div class="form-group-row" style="margin-top: var(--space-md)">
                <div class="form-info">
                    ...
                    <label class="toggle-switch ${!store.isPremium() ? 'disabled' : ''}" for="lock-tag-toggle">
            ...
            <div class="writer-actions">
              ...
              <div class="form-group" style="margin-top: -var(--space-sm)">
                <label class="checkbox-container" for="sequentialMode" style="display: flex; align-items: center; gap: var(--space-sm); font-size: var(--font-size-sm); cursor: pointer;">
